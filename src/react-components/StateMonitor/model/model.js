...
// If your project does not support dynamic reducers then you must manually call
// const reducerFunction = generalReducer(reducerKey, initialState)
// Then install reducerKey and reducerFunction in your global reducers object.
export let isDynamicReducer = true
export const storeIsDefinedCallback = (store, stateAccessors) => {
  isDynamicReducer = store.isDynamicReducerLoading();
