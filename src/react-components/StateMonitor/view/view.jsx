...
const copyClipboardId = 'copyClipboardId'
...
class Clipboard extends React.Component {
  componentDidMount () {
    let copyText = document.getElementById(copyClipboardId)
    copyText.select()
  ...
  render () {
    return (
      <input type='text' defaultValue={this.props.defaultValue} id={copyClipboardId} />
    )
  }
}
